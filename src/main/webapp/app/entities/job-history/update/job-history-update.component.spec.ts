  ...
  describe('JobHistory Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call job query and add missing value', () => {
        ...
        const job: IJob = { id: 31302 };
        jobHistory.job = job;

        const jobCollection: IJob[] = [{ id: 66626 }];
      ...
      it('Should call department query and add missing value', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const department: IDepartment = { id: 67323 };
        jobHistory.department = department;

        const departmentCollection: IDepartment[] = [{ id: 65476 }];
      ...
      it('Should call employee query and add missing value', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const employee: IEmployee = { id: 90767 };
        jobHistory.employee = employee;

        const employeeCollection: IEmployee[] = [{ id: 13841 }];
      ...
      it('Should update editForm', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const job: IJob = { id: 66073 };
        jobHistory.job = job;
        const department: IDepartment = { id: 80994 };
        jobHistory.department = department;
        const employee: IEmployee = { id: 79426 };
        jobHistory.employee = employee;
