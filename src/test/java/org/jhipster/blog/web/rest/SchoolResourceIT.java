...
import org.jhipster.blog.repository.SchoolRepository;
...
class SchoolResourceIT {
    ...
    public static School createEntity(EntityManager em) {
        School school = new School().name(DEFAULT_NAME).principal(DEFAULT_PRINCIPAL);
        return school;
    }
    ...
    public static School createUpdatedEntity(EntityManager em) {
        School school = new School().name(UPDATED_NAME).principal(UPDATED_PRINCIPAL);
        return school;
    }
    ...
    void putNewSchool() throws Exception {
        ...
        updatedSchool.name(UPDATED_NAME).principal(UPDATED_PRINCIPAL);
    ...
    void fullUpdateSchoolWithPatch() throws Exception {
        ...
        partialUpdatedSchool.name(UPDATED_NAME).principal(UPDATED_PRINCIPAL);
