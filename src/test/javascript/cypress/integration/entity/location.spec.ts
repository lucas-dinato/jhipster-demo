...
describe('Location e2e test', () => {
  ...
  it('should create an instance of Location', () => {
    ...
    cy.get(`[data-cy="streetAddress"]`)
      .type('generation Congelado', { force: true })
      .invoke('val')
      .should('match', new RegExp('generation Congelado'));
    ...
    cy.get(`[data-cy="city"]`)
      .type('undefined Daniel do Sul', { force: true })
      .invoke('val')
      .should('match', new RegExp('undefined Daniel do Sul'));

    cy.get(`[data-cy="stateProvince"]`)
      .type('Alameda Prático Plástico', { force: true })
      .invoke('val')
      .should('match', new RegExp('Alameda Prático Plástico'));
